 ...
 * @property {string} [moveInEarliest] Earliest acceptable move-in / availability date, ISO 'YYYY-MM-DD'.
 * @property {string} [moveInLatest] Latest acceptable move-in / availability date, ISO 'YYYY-MM-DD'.
 */
