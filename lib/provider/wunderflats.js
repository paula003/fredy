...
async function fetchDetails(listing, browser) {
  try {
    ...
    const availableFrom = normalizeAvailabilityDate(detail.availableFrom) ?? listing.availableFrom ?? null;
    return { ...listing, address, description: description || listing.description, availableFrom };
  } catch (error) {
