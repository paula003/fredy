...
function normalize(o) {
  ...
  return {
    ...
    // The key-facts block ends with a "frei ab <date>" entry (the only date in
    // that text); the shared parser extracts it and ignores the other facts.
    availableFrom: normalizeAvailabilityDate(o.availableFrom),
  };
}
...
const config = {
  ...
  crawlFields: {
    ...
    availableFrom: 'div[data-testid="cardmfe-keyfacts-testid"] | removeNewline | trim',
  },
  normalize: normalize,
